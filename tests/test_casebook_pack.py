"""Regression checks for the amber-model-metric-grid casebook."""
...
from casebook.harness import assert_expected, amber_model_metric_grid_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(amber_model_metric_grid_summary(), assert_expected())
